...
const CardHeader2: any = styled(CardHeader)(({ theme }: any) => ({
  alignSelf: `stretch`,
  height: `56px`,
  margin: `0px`,
...
const FormEntity1: any = styled('div')(({ theme }: any) => ({
...
const FormEntity2: any = styled(FormEntity)(({ theme }: any) => ({
  alignSelf: `stretch`,
  margin: `0px`,
}));
...
const CardHeader3: any = styled(CardHeader)(({ theme }: any) => ({
  alignSelf: `stretch`,
  height: `56px`,
  margin: `0px`,
  color: theme.palette['text']['primary'],
  ...
  return (
    <EntityContainer1 className={props.className}>
      <Content>
        ...
        <InvestorContainer>
          <CardHeader3 title={'Individual Investors'} />
